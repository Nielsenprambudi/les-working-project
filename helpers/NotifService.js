...
export default class NotifService {
    ...
    PushNotification.createChannel(
      {
        ...
        soundName: "sebissound.mp3", // (optional) See `soundName` parameter of `localNotification` function
  ...
  newLocalNotif(title,msg) {
    ...
    PushNotification.localNotification({
      ...
      subText: 'Notifikasi', // (optional) default: none
      color: 'red', // (optional) default: system default
      vibrate: true, // (optional) default: true
      vibration: 300, // vibration length in milliseconds, ignored if vibrate=false, default: 1000
      tag: 'some_tag', // (optional) add tag to message
    ...
    //   actions: ['Yes', 'No'], // (Android only) See the doc for notification actions to know more
      ...
      userInfo: { screen: 'Main' }, // (optional) default: {} (using null throws a JSON value '<null>' error)
      playSound: 'default', // (optional) default: true
      soundName:'sebissound.mp3', // (optional) Sound to play when the notification is shown. Value of 'default' plays the default sound. It can be set to a custom sound such as 'android.resource://com.xyz/raw/my_sound'. It will look for the 'my_sound' audio file in 'res/raw' directory and play it. default: 'default' (default sound is played)
      number: 10, // (optional) Valid 32 bit integer specified as string. default: none (Cannot be zero)
    });
  }
